import typing as T
from solmoctor.flags import ModifierStatus
from slither.core.declarations import Modifier
from .insecure_path_check_result import InsecurePathCheckResult


ModifierStatusMap: T.TypeAlias = T.Dict[Modifier, T.List[ModifierStatus]]
ModifierCheckResultMap: T.TypeAlias = T.Dict[Modifier, T.List[InsecurePathCheckResult]]
