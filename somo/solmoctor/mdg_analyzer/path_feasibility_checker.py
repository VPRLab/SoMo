...
from solmoctor.core import MDG, EntryPoint, EdgeFlag
from solmoctor.symbolic_engine import SymbolicEngine, Constraint
from solmoctor.flags import VulnerabilityFlag, ProtectingModifierStatus, ModifierStatus
from solmoctor.mdg_analyzer import InsecurePathCheckResult, ConstraintAnalyzer, ContractAnalysisResult
from solmoctor.mdg_analyzer.insecure_path_analyzer import InsecurePathAnalyzer


TConstraintList: T.TypeAlias = T.List[Constraint]
...
class PathFeasibilityChecker:
    ...
    def _obtain_entry_paths(self, insecure_path_list: T.List) -> T.List[T.Tuple[T.Tuple[T.List], T.Optional[ProtectingModifierStatus]]]:
        ...
        for index in range(len(insecure_path_list)):
            ...
            match protecting_modifier_status:
                case [ProtectingModifierStatus.SECURE, ProtectingModifierStatus.UNDETERMINED]:
                    pass
                case [ProtectingModifierStatus.CONDITIONAL, ProtectingModifierStatus.VULNERABLE]:
