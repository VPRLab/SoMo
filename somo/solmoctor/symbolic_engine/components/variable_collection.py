...
TAllIRVariable: T.TypeAlias = T.Union[
    Constant, 
    ReferenceVariable, 
    TemporaryVariable, 
...
TNonSSAVar: T.TypeAlias = T.Union[
    Constant,
    StateVariable,
    LocalVariable,
    TupleVariable,
...
class VariableCollection:
    ...
    def get_key_str_map(self):
        ...
        for key in self._variable_map.keys():
            ...
            if isinstance(key, T.Union[TupleVariable ,SolidityVariableComposed, TemporaryVariable, SolidityVariable, ReferenceVariable]):
                key_map[str(key)] = key
    ...
    def _create_var_by_type(self, var: TNonSSAVar) -> T.Union[Bool, String, Int]:
            ...
            if isinstance(var, T.Union[TemporaryVariable, SolidityVariable, ReferenceVariable, TupleVariable]):
                var_name = var.name
            else:
