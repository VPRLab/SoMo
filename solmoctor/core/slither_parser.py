...
from solmoctor.utils import SolcSwitcher, ContractHelper
from solmoctor.exception import SlitherParsingError, ContractVersionNotFound
...
class SlitherParser:
    ...
    def parse(self, contract_path: str, contract_setting: str):
        # create contract helper for reading compiler version and main contract.
        helper = ContractHelper(contract_setting)
