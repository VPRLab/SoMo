...
from solmoctor.core.cfg import ICFG_SSA
from solmoctor.core.cfg import StateVariableWrapper
from solmoctor.core.cfg.icfg_types import ModifierSinkNode
...
class MDG:
    def __init__(self, contract: Contract, slither_obj: Slither=None) -> None:
        ...
        self._node_filter: T.Callable[[SlitherNode, nx.MultiDiGraph, str], bool] = \
