...
from solmoctor.core.cfg.icfg_ssa import ICFG_SSA
from solmoctor.core.cfg.icfg_types import ICFGNode, ModifierSinkNode
from solmoctor.core.mdg.condition_node_marker import ConditionNodeMarker
from solmoctor.core.mdg.analyze_result import ModifierAnalyzingResultAnalyzer
from solmoctor.core.mdg.analyzer import FunctionTaintAnalyzer, ModifierTaintAnalyzer
from solmoctor.core.mdg.utils import ParameterChecker, TaintVariableType, MDGUtilizer, SinkEdgeManager, UsedVariableProcessingResultFlag
...
class MDGBuilder:
    ...
    def build(self, contract: Contract, slither_obj: Slither = None) -> T.Tuple[MDG, T.Dict]:
