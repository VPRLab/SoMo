...
from solmoctor.core.mdg import MDG
from slither.core.solidity_types import ElementaryType
from slither.core.variables.state_variable import StateVariable
from slither.slithir.operations import InternalCall
from slither.slithir.variables import TemporaryVariable, Constant
from slither.core.declarations import SolidityVariableComposed, Contract, SolidityVariable, EnumContract
from solmoctor.core.mdg.utils import NodeEdgeProcessor, PropagateDirection, TEdgeMap
from solmoctor.core.cfg import FunctionSinkNode, EdgeFlag, StateVariableWrapper, ICFG_SSA, EntryPoint, ModifierSinkNode
    ...
    def _process_var_flow_to_sink(self, var_flow_to_sink) -> T.List:
        ...
        for var in var_flow_to_sink:
            if isinstance(var, Constant):
                continue
            if isinstance(var, T.Union[SolidityVariableComposed, SolidityVariable]):
