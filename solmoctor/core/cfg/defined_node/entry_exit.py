...
class Point(ABC):
    def __init__(self) -> None:
        ...
        self._son_true: T.Optional[SlitherNode] = None
        self._son_false: T.Optional[SlitherNode] = None
    ...
    @property
    def son_true(self) -> T.Optional[SlitherNode]:
    ...
    @property
    def son_false(self) -> T.Optional[SlitherNode]:
