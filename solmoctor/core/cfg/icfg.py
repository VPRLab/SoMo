...
class ICFG:
    ...
    def _init_to_add_node(self, node: T.Union[SlitherNode, StateVariableWrapper], scope: str) \
            -> T.Tuple[T.Union[SlitherNode, StateVariableWrapper], T.Dict]:
    ...
    ) -> T.List[T.Tuple[SlitherNode, T.Dict]]:
        # add all the node to a list of Tuple[SlitherNode, Dict]
        # for later call graph.add_nodes_from functions.

        to_add_node_list: T.List[T.Tuple[SlitherNode, T.Dict]] = list()

        for function in functions:
            nodes: T.List[SlitherNode] = function.nodes_ordered_dominators
    ...
    def _add_call_return_edge(
        ...
        to_add_edge_list: T.List[T.Tuple[SlitherNode, SlitherNode, T.Dict]] = list()
        ...
        for external_call in external_call_list:
            ...
            src_node: SlitherNode = external_call.nodes_ordered_dominators[-1]
    ...
    def _init_icfg(self) -> nx.MultiDiGraph:
        ...
        to_add_node_list: T.List[T.Tuple[SlitherNode, T.Dict]] = \
